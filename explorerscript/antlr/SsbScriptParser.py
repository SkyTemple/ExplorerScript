...
def serializedATN():
    return [
        ...
        8,2,10,2,12,2,58,9,2,1,2,1,2,1,3,1,3,1,3,3,3,65,8,3,1,4,1,4,1,4,
        1,4,1,5,1,5,1,5,1,5,1,6,1,6,1,6,1,6,1,6,1,6,1,6,1,6,1,7,1,7,1,8,
        1,8,3,8,87,8,8,1,8,1,8,1,9,1,9,3,9,93,8,9,1,9,1,9,3,9,97,8,9,1,9,
        1,9,1,10,1,10,1,10,1,10,1,11,1,11,4,11,107,8,11,11,11,12,11,108,
        1,11,3,11,112,8,11,1,11,1,11,1,12,1,12,1,12,1,12,1,13,1,13,1,13,
        5,13,123,8,13,10,13,12,13,126,9,13,1,13,3,13,129,8,13,1,14,1,14,
...
class SsbScriptParser ( Parser ):
    ...
    RULE_func_alias = 12
    RULE_arglist = 13
    RULE_position_marker = 14
    RULE_position_marker_arg = 15
    RULE_label = 16
    RULE_string = 17
    RULE_lang_string = 18
    RULE_lang_string_argument = 19
    RULE_string_value = 20
    RULE_ctx_header = 21

    ruleNames =  [ "pos_argument", "jump_marker", "start", "funcdef", "simple_def", 
                   "coro_def", "for_target_def", "integer_like", "stmt", 
                   "operation", "inline_ctx", "func_suite", "func_alias", 
                   "arglist", "position_marker", "position_marker_arg", 
                   "label", "string", "lang_string", "lang_string_argument", 
                   "string_value", "ctx_header" ]
    ...
    class OperationContext(ParserRuleContext):
        ...
        def inline_ctx(self):
            return self.getTypedRuleContext(SsbScriptParser.Inline_ctxContext,0)
    ...
    class Inline_ctxContext(ParserRuleContext):
        ...
        def ctx_header(self):
            return self.getTypedRuleContext(SsbScriptParser.Ctx_headerContext,0)
        ...
        def getRuleIndex(self):
            return SsbScriptParser.RULE_inline_ctx
    ...
    def inline_ctx(self):
        ...
        localctx = SsbScriptParser.Inline_ctxContext(self, self._ctx, self.state)
        self.enterRule(localctx, 20, self.RULE_inline_ctx)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 100
    ...
    def func_suite(self):
        ...
        self.enterRule(localctx, 22, self.RULE_func_suite)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 104
    ...
    def func_alias(self):
        ...
        self.enterRule(localctx, 24, self.RULE_func_alias)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 115
    ...
    def position_marker(self):
        ...
        self.enterRule(localctx, 28, self.RULE_position_marker)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 130
    ...
    def position_marker_arg(self):
        ...
        self.enterRule(localctx, 30, self.RULE_position_marker_arg)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 139
    ...
    class StringContext(ParserRuleContext):
        ...
        def string_value(self):
            return self.getTypedRuleContext(SsbScriptParser.String_valueContext,0)
    ...
    def lang_string(self):
        ...
        self.enterRule(localctx, 36, self.RULE_lang_string)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 148
    ...
    def lang_string_argument(self):
        ...
        self.enterRule(localctx, 38, self.RULE_lang_string_argument)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 162
            self.match(SsbScriptParser.IDENTIFIER)
    ...
    class String_valueContext(ParserRuleContext):
        ...
        def MULTILINE_STRING_LITERAL(self):
            return self.getToken(SsbScriptParser.MULTILINE_STRING_LITERAL, 0)

        def STRING_LITERAL(self):
            return self.getToken(SsbScriptParser.STRING_LITERAL, 0)

        def getRuleIndex(self):
            return SsbScriptParser.RULE_string_value
    ...
    def string_value(self):
        ...
        localctx = SsbScriptParser.String_valueContext(self, self._ctx, self.state)
        self.enterRule(localctx, 40, self.RULE_string_value)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 166
    ...
    class Ctx_headerContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return SsbScriptParser.RULE_ctx_header
    ...
    def ctx_header(self):
        ...
        localctx = SsbScriptParser.Ctx_headerContext(self, self._ctx, self.state)
        self.enterRule(localctx, 42, self.RULE_ctx_header)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 168
            self.match(SsbScriptParser.IDENTIFIER)
