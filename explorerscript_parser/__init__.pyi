...
class ExplorerScriptParser:
    class StartContext(Antlr4ParseTree):
        ...
        def accept(self, visitor: ExplorerScriptVisitor) -> Any: ...
        def enterRule(self, listener: Unknown) -> None: ...
        def exitRule(self, listener: Unknown) -> None: ...
        @overload
...
class ExplorerScriptParserWrapper:
    ...
    def traverse(self, visitor: ExplorerScriptVisitor) -> Any: ...
...
class SsbScriptParserWrapper:
    ...
    def traverse(self, visitor: SsbScriptVisitor) -> Any: ...
