...
class ExplorerScriptParser:
    ...
    class Integer_likeContext(Antlr4ParserRuleContext):
...
class ExplorerScriptBaseVisitor:
    ...
    def visitInteger_like(self, context: ExplorerScriptParser.Integer_likeContext) -> Any: ...
...
class ExplorerScriptParserWrapper:
    ...
    def addErrorListener(self, listener: Antlr4ErrorListener) -> None: ...
...
class SsbScriptBaseVisitor:
    ...
    def visitInteger_like(self, context: SsbScriptParser.Integer_likeContext) -> Any: ...
